...
class AddressSearchableTest {

    @Mock
    private KakaoAddressService kakaoAddressService;

    @InjectMocks
    private AddressSearchable addressSearchable;
    ...
    void mappingBySearchResponse() throws JsonProcessingException {
        ...
        given(kakaoAddressService.search("전북 삼성동 100"))
                .willReturn(documents);

        final AddressResponse response = addressSearchable.search("전북 삼성동 100");
